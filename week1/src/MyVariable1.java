public class MyVariable1 {
    public static void main(String[] args){
        String name = "Bren"; // after a statement, don't forget the semi colon!
               int hours = 40; // we are assigning 40 to the hour variable
        //Please note, when we have a string value, it is nested in"quotes"
