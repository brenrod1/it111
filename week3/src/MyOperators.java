public class MyOperators {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Hourly rate: $" +hourlyWithOvertime+ " dollars");
...
//        System.out.println("Tax of item $" +taxOnItem+ " dollars");
...
//         tax is 10 percent
//        using one variable will use less code and same answer
        //EXAMPLE BELOW
//        double priceOfItem = 100;
//       priceOfItem *= 1.10;
//
